...
; Functions
declare void @diffkemp.old.task_numa_free(ptr)
declare void @diffkemp.new.task_numa_free(ptr, i1)

define void @diffkemp.old.__put_task_struct(ptr) {
  call void @diffkemp.old.task_numa_free(ptr %0)
  ret void
}

define void @diffkemp.new.__put_task_struct(ptr) {
  call void @diffkemp.new.task_numa_free(ptr %0, i1 zeroext true)
  ret void
}
