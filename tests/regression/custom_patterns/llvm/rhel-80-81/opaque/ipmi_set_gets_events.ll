...
; Functions
declare void @diffkemp.old.cleanup_srcu_struct(ptr)
declare void @diffkemp.new.cleanup_srcu_struct_quiesced(ptr)

define void @diffkemp.old.free_user(ptr) {
  %2 = getelementptr i8, ptr %0, i64 -50456
  %3 = getelementptr inbounds %struct.ipmi_user, ptr %2, i32 0, i32 2
  call void @diffkemp.old.cleanup_srcu_struct(ptr %3), !diffkemp.pattern !0
  ret void, !diffkemp.pattern !1
}

define void @diffkemp.new.free_user(ptr) {
  %2 = getelementptr i8, ptr %0, i64 -50456
  %3 = getelementptr inbounds %struct.ipmi_user, ptr %2, i32 0, i32 2
  call void @diffkemp.new.cleanup_srcu_struct_quiesced(ptr %3), !diffkemp.pattern !0
  ret void, !diffkemp.pattern !1
}
