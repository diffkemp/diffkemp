...
; Functions
declare ptr @lruvec_pgdat(...)
declare void @__mod_node_page_state(...)
declare void @__mod_lruvec_state(...)

define void @diffkemp.old.__update_lru_size(ptr, i32, i32) {
  %4 = call ptr (...) @lruvec_pgdat(ptr %0)
  %5 = sext i32 %2 to i64
  call void (...) @__mod_node_page_state(ptr %4, i32 %1, i64 %5), !diffkemp.pattern !0
  ret void
}

define void @diffkemp.new.__update_lru_size(ptr, i32, i32) {
  %4 = call ptr (...) @lruvec_pgdat(ptr %0)
  call void (...) @__mod_lruvec_state(ptr %0, i32 %1, i32 %2), !diffkemp.pattern !0
  ret void
}
