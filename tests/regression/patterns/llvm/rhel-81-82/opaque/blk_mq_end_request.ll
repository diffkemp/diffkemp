...
define void @diffkemp.old.arch_atomic_dec(ptr) {
  %2 = getelementptr inbounds %struct.custom, ptr %0, i32 0, i32 0
  call void (...) @simpll__inlineasm(ptr %2, ptr %2), !diffkemp.pattern !0
  ret void, !diffkemp.pattern !1
}

define void @diffkemp.new.arch_atomic_dec(ptr) {
  %2 = getelementptr inbounds %struct.custom, ptr %0, i32 0, i32 0
  call void (...) @simpll__inlineasm(ptr %2, ptr %2), !diffkemp.pattern !0
  ret void, !diffkemp.pattern !1
}
