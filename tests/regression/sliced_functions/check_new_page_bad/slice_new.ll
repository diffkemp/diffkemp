define void @check_new_page_bad(%struct.page*) #0 {
  ...
  %3 = bitcast %union.anon.7504143666799817323.14* %2 to %struct.atomic_t*
  %4 = call i32 @atomic_read(%struct.atomic_t* %3)
  %5 = icmp ne i32 %4, -1
  %6 = zext i1 %5 to i32
  %7 = sext i32 %6 to i64
  %8 = icmp ne i64 %7, 0
  %spec.select = select i1 %8, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.47, i64 0, i64 0), i8* null
  ...
  %16 = icmp ne i64 %15, 0
  %.1 = select i1 %16, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.48, i64 0, i64 0), i8* %spec.select
  %17 = call i32 @page_ref_count(%struct.page* %0)
  %18 = icmp ne i32 %17, 0
  %19 = zext i1 %18 to i32
  %20 = sext i32 %19 to i64
  %21 = icmp ne i64 %20, 0
  %spec.select3 = select i1 %21, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.49, i64 0, i64 0), i8* %.1
  br label %22
