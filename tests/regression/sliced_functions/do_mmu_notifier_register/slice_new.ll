...
5:                                                ; preds = %3
  %6 = getelementptr inbounds %struct.anon.2396956502920076489, %struct.anon.2396956502920076489* %4, i32 0, i32 51
  ...
  call void @hlist_add_head_rcu(%struct.hlist_node* %7, %struct.hlist_head* %9)
  br label %10
