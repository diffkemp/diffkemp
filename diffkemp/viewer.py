"""view function for running the result viewer"""
from diffkemp.syndiff.function_syntax_diff import unified_syntax_diff
from http.server import HTTPServer, SimpleHTTPRequestHandler
from diffkemp.utils import CMP_YAML_FILENAME
import sys
import os
import errno
import yaml
...
class Viewer:
    ...
    def _load_yaml(self):
        ...
        yaml_path = os.path.join(self.compare_output_dir, CMP_YAML_FILENAME)
    ...
    def _prepare_files_and_diffs(self):
        ...
        self.viewer_yaml_path = os.path.join(self.data_dir, CMP_YAML_FILENAME)
