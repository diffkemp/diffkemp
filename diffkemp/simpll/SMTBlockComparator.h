...
class SMTBlockComparator {
  ...
  private:
    ...
    /// Create a Z3 variable prefixed with the given string that represents
    /// the result register of an LLVM Instruction.
    static z3::expr createResultVar(z3::context &c,
                                    const std::string &prefix,
