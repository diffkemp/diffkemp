...
def run_simpll(first, second, fun_first, fun_second, var, suffix=None,
               ...
               module_cache=None, equivalence_slicer=False):
    """
    ...
    if use_ffi:
        ...
        conf_struct.EquivalenceSlicer = equivalence_slicer
        ...
        try:
            ...
            if equivalence_slicer:
                simpll_command.append("--equivalence-slicer")

            simpll_out = check_output(simpll_command)
        except CalledProcessError:
            raise SimpLLException("Simplifying files failed")

    if output_llvm_ir and not equivalence_slicer:
