...
def run_simpll(first, second, fun_first, fun_second, var, var_indices=None,
               suffix=None, cache_dir=None, control_flow_only=False,
               output_llvm_ir=False, print_asm_diffs=False, verbose=False,
               use_ffi=False, no_missing_def=False):
    """
