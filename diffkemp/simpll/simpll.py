...
def run_simpll(first, second, fun_first, fun_second, var, config, suffix=None,
    ...
    if config.use_ffi:
        ...
        fst_fixed_index, snd_fixed_index, fst_fixed_value, snd_fixed_value =\
            fixed_params
        ...
        conf_struct.FirstFixedParamIndex = fst_fixed_index
        conf_struct.SecondFixedParamIndex = snd_fixed_index
        conf_struct.FirstFixedParamValue = fst_fixed_value
        conf_struct.SecondFixedParamValue = snd_fixed_value
